...
function initialize() {
  	var mapOptions = {
      	center: new google.maps.LatLng(25.047924,121.517081),
      	zoom: 12,
...
function add_waypoint()
{
    ...
    waypoint_container+= '  <label class="control-label" for="inputEmail">From :</label>';
    ...
    waypoint_container+= '      &nbsp;<a href="#" onclick="return add_waypoint();">Add</a>';
